...
class TestPublicEndpoints:
    ...
    def test_trains_success(self, client, app_module):
        ...
        with (
            patch("server.validate_station_name") as mock_validate,
...
class TestHelpers:
    ...
    def test_sanitize_input(self, app_module):
        ...
        assert (
            sanitize("test<script>") == "test<script>"
        )  # Current impl acts as simple filter or existence check?
